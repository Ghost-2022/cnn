...
def preHandle():
    ...
    handled_file = 'kddcup.data_train.csv'
    ...
    with (open(source_file,'r')) as data_from:
        ...
        for i in csv_reader:
            ...
            temp_line[41]=handleLabel(i)           #将源文件行中23种攻击类型转换成数字标识 22+normal
...
def handleLabel(input):
    staut_list = ['normal.', 'buffer_overflow.', 'loadmodule.', 'warezmaster.', 'neptune.', 'smurf.', 'guess_passwd.', 'pod.', 'teardrop.', 'portsweep.', 'ipsweep.', 'land.', 'ftp_write.', 'back.', 'imap.', 'satan.', 'phf.', 'nmap.', 'multihop.', 'warezmaster.', 'warezclient.', 'spy.', 'rootkit.']
